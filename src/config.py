...
FIELD_DEFINITIONS = {
    ...
    'path': {'type': 'string', 'required': False, 'validator': validate_path, 'filterable': True},
    'type': {'type': 'string', 'required': False, 'filterable': True},
    'specific_url': {'type': 'string', 'required': False, 'validator': validate_url, 'filterable': True},
    'alternate_url': {'type': 'string', 'required': False, 'validator': validate_url, 'filterable': True},
    'navigation_path': {'type': 'string', 'required': False, 'validator': validate_path, 'filterable': True},
    ...
    'last_file_path': {'type': 'string', 'required': False, 'filterable': True},
    'last_file_url': {'type': 'string', 'required': False, 'filterable': True},
    ...
    'section_path': {'type': 'string', 'required': False, 'filterable': True},
